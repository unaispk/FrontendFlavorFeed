...
import {popularRecipe } from '../../RecipeDatas'
import { useNavigate } from 'react-router'

const HomePopularRecipeCard = () => {
                ...
                <div className="card card-compact w-64 bg-white shadow-xl rounded-none transition transform hover:scale-105">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions justify-end">
                            <button className="bg-primary text-white  px-6 py-2 rounded-full" onClick={()=>{viewRecipe(recipe.id,'popular')}}>Get Recipe</button>
                        </div>
                    </div>
                </div>
            </div>
...
export default HomePopularRecipeCard
