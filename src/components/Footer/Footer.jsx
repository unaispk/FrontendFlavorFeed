...
function Footer() {
  return (
    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      ...
      <div class="sm:flex md:justify-around  sm:items-center sm:justify-between">
      ...
      <div className="bg-white">
        <footer className="footer p-10 bg-base-200 text-base-content border-t">
          <nav>
            ...
            <p className="  hover:text-primary">Branding</p>
        ...
        <footer className="footer px-10 py-4  bg-[#d4dbff2e] text-base-content ">
          <aside className="items-center grid-flow-col">
            <img width="62" height="auto"  src={Logo} alt="logo" className="mr-4 md:cursor-pointer h-9" />
            ...
            <p>Flavor Feed Pvt Ltd. <br />Providing delicious recipes since 2014</p>
          </aside>
          <nav className="md:place-self-center md:justify-self-end">
            <div className="grid grid-flow-col gap-4">
              <Link to={'/'}> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current text-black"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>              </Link>
              ...
              <Link to={'/'}><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current text-blue-600"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"></path></svg></Link>
            </div>
          </nav>
        </footer>
      </div>
